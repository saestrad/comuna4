      ...
      <section className="px-6 md:px-12 py-[120px]">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row md:items-end md:justify-between gap-8">
          ...
          <div className="flex items-center gap-4 shrink-0">
            <Link href="/lofi/solicitud" className="inline-block bg-neutral-900 text-white text-sm font-medium px-8 py-4 rounded-full transition-colors hover:bg-neutral-700">
              Solicitar →
            </Link>
