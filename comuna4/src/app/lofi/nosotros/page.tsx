...
export default function LofiSobre() {
  return (
    <div>
      ...
      <section className="px-6 pt-16 pb-14 border-b border-neutral-200">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-end">
          <div>
            ...
            <h1 className="text-6xl font-black text-neutral-900 tracking-tight leading-none mb-6">
      ...
      <section className="px-6 py-16 border-b border-neutral-200">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
            {leadership.map((p) => (
              <div key={p.name}>
                <div className="aspect-square bg-neutral-100 rounded border border-neutral-200 mb-3" />
      ...
      {/* Partners */}
      <section className="px-6 py-16 border-b border-neutral-200 bg-neutral-50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-neutral-200">
            {partners.map((p) => (
              <div key={p.name} className="bg-white p-6">
                <div className="h-10 bg-neutral-100 rounded mb-4 border border-neutral-200" />
      ...
      <section className="px-6 py-20">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row md:items-end md:justify-between gap-8">
          ...
          <div className="flex items-center gap-4 shrink-0">
            <Link href="/lofi/solicitud" className="inline-block bg-neutral-900 text-white text-sm font-medium px-8 py-4 rounded transition-colors hover:bg-neutral-700">
              Solicitar →
            </Link>
