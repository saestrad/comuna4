...
export default function LofiHome() {
  return (
    <div>
      ...
      {/* Hero */}
      <section className="px-6 pt-20 pb-18 border-b border-neutral-200">
        <div className="max-w-5xl mx-auto">
          <p className="text-xs font-mono uppercase tracking-widest text-neutral-500 mb-8">
            Agencia creativa — Puerto Rico
          </p>
          <h1 className="text-7xl font-black text-neutral-900 tracking-tight leading-none mb-7 max-w-[14ch]">
            Hacemos que tu marca crezca.
          </h1>
          <p className="text-lg text-neutral-500 leading-relaxed mb-10 max-w-[44ch]">
      ...
      {/* Ticker */}
      <section className="border-b border-neutral-200 py-4 overflow-hidden">
        <div className="flex gap-10 px-6 font-mono text-xs uppercase tracking-widest text-neutral-500 whitespace-nowrap">
      ...
      {/* Featured works */}
      <section className="px-6 py-18 border-b border-neutral-200">
        <div className="max-w-5xl mx-auto">
      ...
      <section className="px-6 py-18 border-b border-neutral-200">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-xs font-mono uppercase tracking-widest text-neutral-500 mb-12">Lo que hacemos</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-neutral-200">
            {[
              ...
              <Link key={s.name} href="/lofi/servicios" className="bg-white p-6 hover:bg-neutral-50 transition-colors group">
      ...
      {/* Hub / Spaces */}
      <section className="px-6 py-18 border-b border-neutral-200 bg-neutral-50">
        <div className="max-w-5xl mx-auto">
          <p className="text-xs font-mono uppercase tracking-widest text-neutral-500 mb-4">El Hub</p>
          <h2 className="text-4xl font-black text-neutral-900 tracking-tight leading-none mb-4 max-w-[22ch]">
            Donde la creatividad se produce.
          </h2>
          <p className="text-sm text-neutral-500 leading-relaxed mb-12 max-w-[48ch]">
      ...
      <section className="px-6 py-24">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row md:items-end md:justify-between gap-10">
          <div>
            <h2 className="text-5xl font-black text-neutral-900 tracking-tight leading-none mb-4">
              ¿Tienes un proyecto?
            </h2>
